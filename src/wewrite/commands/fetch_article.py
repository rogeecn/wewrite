...
Usage:
    wewrite fetch-article <url>                    # auto fetch
    wewrite fetch-article <url> -o article.md      # save to file
    wewrite fetch-article --file saved.html        # from local HTML
    wewrite fetch-article <url> --json             # JSON output for agent
"""
